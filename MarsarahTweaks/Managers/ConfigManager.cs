...
namespace MarsarahTweaks.Managers
{
	public static class ConfigManager
	{
		...
		public static class Configs
		{
			...
			public static readonly ConfigMetadata StopNighttimeInvasion = new ConfigMetadata("05 - Stop Nighttime Invasion", "Fulings, Seeker and Charred no longer spawn in early biomes at night. (Fulings spawn in Mountains and Seeker and Charred spawn in Plains)");
			...
			public static readonly ConfigMetadata UILayoutMode = new ConfigMetadata("02 - UI Layout Mode", "Choose the layout of the following 7 UI elements added by this mod. New version uses symbols and filling bars. Old version uses more text and has the boat speed indicator next to the enemy detector.");
			...
			public static readonly ConfigMetadata UISmartBiome = new ConfigMetadata("07 - Smart Biome Indicator", "Shows smart biome text on the minimap (colored according to worn armor relative to current biome)");
			...
			public static readonly ConfigMetadata UIOnlinePlayersMode = new ConfigMetadata("09 - Show Online Players", "Displays a list of online players. The player names can be toggled with the Home key. (Not displayed if only one player is online)");
			public static readonly ConfigMetadata UIShowOwnedResources = new ConfigMetadata("10 - Show Owned Resources In Build Menu", "Displays the total amount of resources in the player's inventory in addition to the required resource amount for the selected piece or recipe in the build or crafting menu");
			public static readonly ConfigMetadata UIShowPowerExpiration = new ConfigMetadata("11 - Show Boss Power Expiration Message", "Displays a message in the center of the screen when any Forsaken Power expires");
			public static readonly ConfigMetadata UIPlayerLogoutAnnounce = new ConfigMetadata("12 - Player Logout Announce", "Displays a message when a player logs out in the top-left corner of the screen and in the chat window");
