...
namespace MarsarahTweaks.Managers
{
	public static class ConfigManager
	{
		...
		public static class Configs
		{
			...
			public static readonly ConfigMetadata UIWeatherIndicator = new ConfigMetadata("07 - Show Weather Indicator", "Shows the current weather as an icon at the bottom-right of the minimap.");
