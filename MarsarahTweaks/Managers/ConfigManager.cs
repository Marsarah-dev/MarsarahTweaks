...
namespace MarsarahTweaks.Managers
{
	public static class ConfigManager
	{
		...
		public static class Configs
		{
			...
			public static readonly ConfigMetadata PortalsPerPlayer = new ConfigMetadata("15 - Max Portals Per Player", "Set the maximum number of portals each player can build per world. The limit applies individually to the vanilla normal portal, stone portal, and Glacial Stone Portal when available from MarsarahBuildPieces. Set to 0 to prevent portal placement or -1 for unlimited portals. Server admins are exempt.");
		...
		public static void Init(ConfigFile configFile)
		{
			...
			MaxPortalsPerPlayer = CreateConfig(ConfigSections.Features, Configs.PortalsPerPlayer.Name, -1, Configs.PortalsPerPlayer.Description, true, new AcceptableValueRange<int>(-1, 50));
		...
		{
			var configEntry = Config.Bind(group, name, defaultValue, new ConfigDescription(description, acceptableValues));
