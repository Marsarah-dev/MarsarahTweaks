...
//				if (!ConfigManager.cheaperGearEnabled.Value && !ConfigManager.altGearRecipesEnabled.Value) return;
...
//				if (ConfigManager.cheaperGearEnabled.Value == true)
//				{
//					MarsarahTweaks.MLog("Cheaper gear recipes applied.");
//				}
//				else
//				{
//					MarsarahTweaks.MLog("Cheaper gear recipes NOT applied.");
//				}

//				if (ConfigManager.altGearRecipesEnabled.Value == true)
//				{
//					MarsarahTweaks.MLog("Alternate gear recipes applied.");
//				}
//				else
//				{
//					MarsarahTweaks.MLog("Alternate gear recipes NOT applied.");
//				}
//			}
//		}
//	}
