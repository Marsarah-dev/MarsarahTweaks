		...
		class FoodAndMeadChanges_Patch
		{
			static void Postfix(ref ObjectDB __instance)
			{
				...
				if (ZNet.instance != null)
				{
					...
					{
						MarsarahTweaks.MLog($"ObjectDB Awake: I am a server. No changes made to {ConfigManager.Configs.FoodAndMeadModifications.Name}...");
					}
				}
				else
				{
					MarsarahTweaks.MLog($"ObjectDB Awake: Too early to do anything. No changes made to {ConfigManager.Configs.FoodAndMeadModifications.Name}...");
				}
			}
		}
